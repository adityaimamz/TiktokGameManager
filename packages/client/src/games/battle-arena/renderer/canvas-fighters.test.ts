...
import { computeStageLayout, fighterDiameter } from './layout.js'
import { FIGHTER_SCALE_MAX, FIGHTER_SCALE_MIN, fighterScale } from '../arena.js'
import { UltimateFxImpulse } from './fx/fx-impulse.js'
