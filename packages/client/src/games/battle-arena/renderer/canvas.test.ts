...
import { EFFECT_TYPES, defaultConfig } from '../config/index.js'
import type { BattleArenaConfig, NukeType } from '../config/index.js'
import { AvatarCache } from './avatar-cache.js'
import { clearStage, drawEffects, drawProjectiles, drawZones, shakeOffset } from './canvas.js'
import { DeathFade } from './death-fade.js'
import { HpDisplay } from './hp-display.js'
import { PROJECTILE_RADIUS } from '../arena.js'
import { arenaLengthY, computeStageLayout } from './layout.js'
import { depsFor } from '../../../testing/ultimate-fixtures.js'
import type { RenderDeps } from './canvas.js'
