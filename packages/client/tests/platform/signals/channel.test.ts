...
import { MAX_POLL_INTERVAL_MS, createSignalChannel, storageKeyFor } from '../../../src/platform/signals/channel.js'
import type { BroadcastLike, SignalMessage, StorageLike } from '../../../src/platform/signals/channel.js'
