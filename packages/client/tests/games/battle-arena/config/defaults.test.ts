...
import { EFFECT_TYPES, NUMERIC_RANGES, SOUND_EVENTS } from '../../../../src/games/battle-arena/config/schema.js'
import type { NumericField } from '../../../../src/games/battle-arena/config/schema.js'
